...
public class ArmorList {
    ...
    public static Armor chainHead = new Armor("Chain Cap", "Head", 3);
    public static Armor chainBody = new Armor("Chain Tunic", "Body", 3);
    public static Armor chainLegs = new Armor("Chain Trousers", "Legs", 3);

    public static Armor plateHead = new Armor("Plate Helm", "Head", 4);
    public static Armor plateBody = new Armor("Plate Cuirass", "Body", 4);
    public static Armor plateLegs = new Armor("Plate Greaves", "Legs", 4);
